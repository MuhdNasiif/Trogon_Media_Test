...
class Data {
    ...
    factory Data.fromJson(Map<String, dynamic> json) => Data(
        ...
        testimonial: json["testimonial"] == null ? [] : List<dynamic>.from(json["testimonial"]!.map((x) => x)),
        adBanner: json["ad_banner"] == null ? [] : List<AdBanner>.from(json["ad_banner"]!.map((x) => AdBanner.fromJson(x))),
        topCourses: json["top_courses"] == null ? [] : List<Course>.from(json["top_courses"]!.map((x) => Course.fromJson(x))),
        trendingCourses: json["trending_courses"] == null ? [] : List<Course>.from(json["trending_courses"]!.map((x) => Course.fromJson(x))),
        demoVideos: json["demo_videos"] == null ? [] : List<dynamic>.from(json["demo_videos"]!.map((x) => x)),
        demoQuizzes: json["demo_quizzes"] == null ? [] : List<dynamic>.from(json["demo_quizzes"]!.map((x) => x)),
    ...
    Map<String, dynamic> toJson() => {
        ...
        "testimonial": testimonial == null ? [] : List<dynamic>.from(testimonial!.map((x) => x)),
        "ad_banner": adBanner == null ? [] : List<dynamic>.from(adBanner!.map((x) => x.toJson())),
        "top_courses": topCourses == null ? [] : List<dynamic>.from(topCourses!.map((x) => x.toJson())),
        "trending_courses": trendingCourses == null ? [] : List<dynamic>.from(trendingCourses!.map((x) => x.toJson())),
        "demo_videos": demoVideos == null ? [] : List<dynamic>.from(demoVideos!.map((x) => x)),
        "demo_quizzes": demoQuizzes == null ? [] : List<dynamic>.from(demoQuizzes!.map((x) => x)),
